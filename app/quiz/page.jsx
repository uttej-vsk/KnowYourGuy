...
export default async function Page() {
  ...
  return (
    <Container
      as="main"
      className="flex flex-col gap-5 py-4 md:flex-row-reverse md:justify-between"
    >
      <div className="relative overflow-hidden rounded-2xl">
        <div className="md:w-[24rem]">
          <Image src="/wallpaper.jpg" alt="" width={700} height={700} />
        </div>
        <div className="absolute top-0 bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent md:bg-gradient-to-t"></div>
      </div>
      ...
      <div className="md:w-[50%] flex flex-col gap-5">
        ...
        <Link
          ...
          className="flex items-center justify-center gap-1 px-5 py-4 font-semibold text-orange-500 transition-colors rounded-md outline duration-500 hover:bg-orange-900"
        >
